// -----------------------------------------------------------------------
// <copyright file="CSharpScriptNodeJsonConverter.cs" company="FuzzyPotato">
...
namespace FuzzyPotato.Core.Tests.Examples.Nodes
{
    ...
    /// <summary>
    /// JSON converter for CSharpScriptNode.
    /// </summary>
    public class CSharpScriptNodeJsonConverter : JsonConverter<CSharpScriptNode>
    {
        /// <inheritdoc/>
        public override CSharpScriptNode? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        /// <inheritdoc/>
        public override void Write(Utf8JsonWriter writer, CSharpScriptNode value, JsonSerializerOptions options)
        {
