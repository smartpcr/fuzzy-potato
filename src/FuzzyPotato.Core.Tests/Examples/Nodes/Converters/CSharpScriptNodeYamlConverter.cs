// -----------------------------------------------------------------------
// <copyright file="CSharpScriptNodeYamlConverter.cs" company="FuzzyPotato">
...
namespace FuzzyPotato.Core.Tests.Examples.Nodes.Converters
{
    ...
    /// <summary>
    /// YAML converter for CSharpScriptNode.
    /// </summary>
    public class CSharpScriptNodeYamlConverter : IYamlTypeConverter
    {
        /// <inheritdoc/>
        public bool Accepts(Type type)
        {
            return type == typeof(CSharpScriptNode);
        }
        ...
        {
            if (value is not CSharpScriptNode node)
            {
