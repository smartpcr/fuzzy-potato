// -----------------------------------------------------------------------
// <copyright file="PowerShellScriptNodeJsonConverter.cs" company="FuzzyPotato">
...
namespace FuzzyPotato.Core.Tests.Examples.Nodes.Converters
{
    ...
    /// <summary>
    /// JSON converter for PowerShellScriptNode.
    /// </summary>
    public class PowerShellScriptNodeJsonConverter : JsonConverter<PowerShellScriptNode>
    {
        /// <inheritdoc/>
        public override PowerShellScriptNode? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        /// <inheritdoc/>
        public override void Write(Utf8JsonWriter writer, PowerShellScriptNode value, JsonSerializerOptions options)
        {
