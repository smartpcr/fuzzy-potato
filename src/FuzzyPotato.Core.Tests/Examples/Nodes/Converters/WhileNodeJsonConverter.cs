// -----------------------------------------------------------------------
// <copyright file="WhileNodeJsonConverter.cs" company="FuzzyPotato">
...
namespace FuzzyPotato.Core.Tests.Examples.Nodes.Converters
{
    ...
    /// <summary>
    /// JSON converter for WhileNode.
    /// </summary>
    public class WhileNodeJsonConverter : JsonConverter<WhileNode>
    {
        /// <inheritdoc/>
        public override WhileNode? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        /// <inheritdoc/>
        public override void Write(Utf8JsonWriter writer, WhileNode value, JsonSerializerOptions options)
        {
