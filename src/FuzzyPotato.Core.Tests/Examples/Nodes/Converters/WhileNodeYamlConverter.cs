// -----------------------------------------------------------------------
// <copyright file="WhileNodeYamlConverter.cs" company="FuzzyPotato">
...
namespace FuzzyPotato.Core.Tests.Examples.Nodes.Converters
{
    ...
    /// <summary>
    /// YAML converter for WhileNode.
    /// </summary>
    public class WhileNodeYamlConverter : IYamlTypeConverter
    {
        /// <inheritdoc/>
        public bool Accepts(Type type)
        {
            return type == typeof(WhileNode);
        }
        ...
        {
            if (value is not WhileNode node)
            {
