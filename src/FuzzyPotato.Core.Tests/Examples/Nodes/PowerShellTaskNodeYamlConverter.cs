// -----------------------------------------------------------------------
// <copyright file="PowerShellTaskNodeYamlConverter.cs" company="FuzzyPotato">
...
namespace FuzzyPotato.Core.Tests.Examples.Nodes
{
    ...
    /// <summary>
    /// YAML converter for PowerShellTaskNode.
    /// </summary>
    public class PowerShellTaskNodeYamlConverter : IYamlTypeConverter
    {
        /// <inheritdoc/>
        public bool Accepts(Type type) => type == typeof(PowerShellTaskNode);
        ...
        {
            if (value is not PowerShellTaskNode node)
            {
                return;
            }
